...
<table width="100%" border="0">
  ...
  <div class="sidebar_box">
    ...
    <form action="#" method="get">
      <input type="text"  name="q" size="10" class="inputfield" title="searchfield" onfocus="clearText(this)" onblur="clearText(this)" />
    ...
    <div id="templatemo_content">
      <div class="post_section">
                <?php
				 $sorgu="SELECT * FROM alt_konu WHERE id=$sor_id order by id desc";
				 $sonuc=mysql_query($sorgu);
				 while($row=mysql_fetch_array($sonuc))
				 {
					 extract($row); 
					 ...
					 <div id="detay">
                     	<div id="detay1">
                        	<div id="detay1_1">Konu Başlığı</div>
                        	<div id="detay1_2"><?php echo"$konu_basligi"; ?></div>
                        </div>
                        <div id="detay1">
                        	<div id="detay1_1">Konu Alt Başlığı</div>
                        	<div id="detay1_2"><?php echo"$konu_alt_basligi"; ?></div>
                        </div>
                        <div id="detay2">
                            <div id="detay2_1">Konu Formülü</div>
                            <div id="detay2_2"><?php echo"$konu_formulu"; ?></div>
                        </div>
                        <div id="detay2">
                            <div id="detay2_1">Konu Örneği</div>
                            <div id="detay2_2"><?php echo"$konu_ornegi"; ?></div>
                        </div>
                     </div>
					 <?php 
				 echo"</form>";}
